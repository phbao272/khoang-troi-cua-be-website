...
import introductionData from '../../utils/introduction.json';
    ...
    <>
      <section className="introduction pt-4">
        <div className="flex flex-col justify-center items-center mb-5">
          <h1 className="title-section mb-2" data-aos="fade-right">Giới thiệu chung</h1>
          <span className="span-section">Giới thiệu chung về Khoảng Trời Của Bé.</span>
        </div>
      ...
      <section className="timeline mt-5">
        <div className="flex flex-col justify-center items-center mb-5">
          <h1 className="title-section mb-2" data-aos="fade-right">Chặng đường đã đi</h1>
          <span className="span-section">Cùng trải nghiệm với Khoảng Trời Của Bé.</span>
        </div>
        <div className="timeline-background" data-aos="fade-down" data-aos-duration="2000"></div>
        <div className="timeline-form">
          <div className="timeline-item">
            <div className="timeline-item-year" data-aos="zoom-in-up" data-aos-duration="2000">
              2015
            </div>
            ...
            <div className="timeline-item-content">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium quaerat tempore alias at
              distinctio inventore optio veritatis! Est aliquam assumenda nostrum quisquam asperiores,
              necessitatibus modi ut suscipit aut nemo architecto?
            </div>
          </div>
          <div className="timeline-item">
            <div className="timeline-item-year" data-aos="zoom-in-down" data-aos-duration="2000">
              2016
            </div>
            <div className="timeline-item-image">
              <img
      ...
      <section className="vision mt-5">
        <div className="flex flex-col justify-center items-center mb-5">
          <h1 className="title-section mb-2" data-aos="fade-right">Tầm nhìn & Sứ mệnh</h1>
          <span className="span-section">Chúng tôi khát vọng về một tương lai tươi sáng</span>
        </div>
        ...
        <div className="vision-form">
          <div className="vision-box">
            {/* <h4 className="vision-box-title" style="background-image: linear-gradient(to right bottom, #f40076, #df98fa)">Tầm
              nhìn</h4> */}
            <p className="vision-box-content">Lorem ipsum dolor sit amet consectetur adipisicing elit. Provident
              inventore unde expedita quis iure reprehenderit, deleniti ea, in, quasi aperiam excepturi
              maxime qui exercitationem amet?
              Animi blanditiis quidem recusandae velit. Lorem ipsum dolor sit amet consectetur adipisicing
              elit.</p>
            <button className="btn-vision"><i className="fa-solid fa-eye"></i></button>
          </div>
          <div className="vision-box">
            ...
            <p className="vision-box-content">Lorem ipsum dolor sit amet consectetur adipisicing elit. Provident
              inventore unde expedita quis iure reprehenderit, deleniti ea, in, quasi aperiam excepturi
              maxime
              qui exercitationem amet?
              Animi blanditiis quidem recusandae velit. Lorem ipsum dolor sit amet consectetur adipisicing
              elit.</p>
            <button className="btn-mission"><i className="fa-solid fa-bars-progress"></i></button>
          </div>
        </div>
      </section>
    </>
